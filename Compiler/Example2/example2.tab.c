...
static const yytype_int8 yyrhs[] =
{
      ...
      10,     4,    11,    -1,    10,     5,    11,    -1,     6,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint16 yyrline[] =
{
       0,   389,   389,   390,   431,   441,   457,   475
};
#endif
...
{
  "$end", "error", "$undefined", "NUMBER", "ADD", "SUB", "LOG", "EOL",
  "$accept", "commandlist", "exp", "term", 0
};
#endif
...
#line 431 "example2.y"
    ...
    // printf("%s\n", $$);
    // printf("--------\n");
    int base = atoi(extractSubstring((yyvsp[(1) - (1)].strval), 'g', '('));
    int x = atoi(extractSubstring((yyvsp[(1) - (1)].strval), '(', ')'));
    LOGMAP[base] *= x;
;}
    break;
...
#line 441 "example2.y"
    {
    int base = atoi(extractSubstring((yyvsp[(3) - (3)].strval), 'g', '('));
    int x = atoi(extractSubstring((yyvsp[(3) - (3)].strval), '(', ')'));
    LOGMAP[base] *= x;
...
#line 475 "example2.y"
    {
    (yyval.strval) = combineToNewLOG((yyvsp[(1) - (1)].strval));
;}
    break;
